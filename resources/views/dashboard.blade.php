<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Customer Feedback') ?? 'Customer Feedback' }}
        </h2>
    </x-slot>
                            ...
                            <div>
                                <button type="submit" id="submitButton"
                                    ...
                                    <span id="spinner" class="hidden ml-2">
                                        <svg class="class animate-spin h-5 w-5 text-white"
                                            xml="http://www.w3.org/2000/svg" fill="none" viewbox="0 0 24 24">
                                            <circle class="class opacity-25" cx="12" cy="12" r="10"
                                                stroke="currentColor" stroke-width="4"></circle>
                                            <path class="class opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0
